...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.ViewHolder> {
    ...
    private ArrayList <CommunityPostDto> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    // data is passed into the constructor
    public MyRecyclerViewAdapter(Context context, ArrayList<CommunityPostDto> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.custom_post_view_community, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        CommunityPostDto title = mData.get(position);
    ...
    CommunityPostDto getItem(int id) {
        return mData.get(id);
    }
